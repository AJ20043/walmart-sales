...
--  EXTRA TRIGGER FOR NOT USING THE CASE  --
 DROP TRIGGER BRANCH_COUNT;
CREATE TRIGGER BRANCH_COUNT1
AFTER INSERT
ON SALES
FOR EACH ROW
UPDATE BRANCH
SET COUNT= (SELECT COUNT(BRANCH) FROM SALES WHERE BRANCH.BRANCH=SALES.BRANCH)
;
...
INSERT INTO SALES
VALUES ('122-32-1224','D',2,'Food and beverages',34.12,6,12.4423,334.4343,'2019-03-31','12:12:00','Evening','Monday','March','cash',210.32,4.234324224,16.2343,8.9);
